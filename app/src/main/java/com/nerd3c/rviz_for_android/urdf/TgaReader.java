package com.nerd3c.rviz_for_android.urdf;
...
// Code from the cocos2d Android API
// http://code.google.com/p/cocos2d-android/source/browse/trunk/src/org/cocos2d/opengl/TGA.java?r=89

public class TgaReader {
    private static final String LOG_TAG = TgaReader.class.getSimpleName();


    public static class ImageTGA {
        public TGAError status;
        int type, pixelDepth;
