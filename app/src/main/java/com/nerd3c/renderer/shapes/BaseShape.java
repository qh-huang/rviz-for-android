...
import com.nerd3c.renderer.SelectionManager;
import com.nerd3c.renderer.layer.InteractiveObject;
import com.nerd3c.renderer.layer.Selectable;
import com.nerd3c.rviz_for_android.drawable.GLSLProgram;
import com.nerd3c.rviz_for_android.drawable.GLSLProgram.ShaderVal;
...
public abstract class BaseShape implements Shape, Selectable, BaseShapeInterface {
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#setProgram(com.nerd3c.rviz_for_android.drawable.GLSLProgram)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#draw(javax.microedition.khronos.opengles.GL10)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#getColor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#setColor(com.nerd3c.renderer.shapes.Color)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#getTransform()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#setTransform(org.ros.rosjava_geometry.Transform)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nerd3c.renderer.shapes.BaseShapeInterface#setSelected(boolean)
	 */
	@Override
